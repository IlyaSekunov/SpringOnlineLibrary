...
public class BookController {
  ...
  public String showAllBooks(
      ...
      @RequestParam(value = "books_per_page", required = false, defaultValue = "0")
          int booksPerPage,
  ...
  public String updateBookOwner(
      @PathVariable("id") int bookId, @RequestParam("newOwner") int newOwnerId) {
  ...
  public String searchBook(
      @RequestParam(value = "search_string", required = false) String searchString, Model model) {
